...
class TreeApp {
   public static void main(String[] args) throws IOException {
      ...
      while (true) {
         ...
         System.out.print("insert, find, delete, traverse, clearTree, insert random items, mfind minimal, afind maximal, or quit: ");
         int choice = getChar();
         switch (choice) {
            case 'm':
               System.out.println("The minimal item: ");
               theTree.findMinimal().displayNode();
               break;
            case 'a':
               System.out.println("The maximal item: ");
               theTree.findMaximial().displayNode();
               break;
            case 's':
            ...
            case 'r':
               ...
               System.out.print("Insert random value: " +value);
               theTree.insert(value, value + 0.9);
               System.out.println("\nNow the Tree is: ");
               theTree.displayTree();
               System.out.println("Comparisons = " + theTree.comps);
...
class Tree {
   ...
   private void preOrder(Node localRoot) {
      if (localRoot != null) {
         ilist.add(localRoot.iData);
         dlist.add(localRoot.dData);
   ...
   public void resert(){
      ...
      for(int i=0;i<ilist.size();i++){
         insert(ilist.get(i), dlist.get(i));
      }
      ilist.clear();
      dlist.clear();
   }
